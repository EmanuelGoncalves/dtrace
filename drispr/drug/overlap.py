...
from drispr import is_same_drug


if __name__ == '__main__':
    # - Imports
    d_v17 = pd.read_csv(drispr.DRUG_RESPONSE_V17)
    d_vrs = pd.read_csv(drispr.DRUG_RESPONSE_VRS)
    ...
    for t, f in [('All', False), ('Pub or Web', True)]:
        ...
        ds = drispr.import_drug_list(filter_web_pub=f)
    ...
    pal = dict(zip(*(set(plot_df['variable']), [drispr.PAL_SET2[8], drispr.PAL_SET2[1]])))
